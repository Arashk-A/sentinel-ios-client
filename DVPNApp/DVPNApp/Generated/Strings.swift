...
internal enum L10n {
  ...
  internal enum SubscribedNodes {
    ...
    internal enum Error {
      /// Subscriptions can not be cancelled while you have an active session. Please, try again later
      internal static let activeSession = L10n.tr("Localizable", "SubscribedNodes.Error.ActiveSession")
